...
public class DorylusNigricans : MonoBehaviour
{
	// Token: 0x0600070E RID: 1806 RVA: 0x000FE008 File Offset: 0x000FC208
	private void Start()
	{
	...
	// Token: 0x0600070F RID: 1807 RVA: 0x000FE080 File Offset: 0x000FC280
	private void Update()
	{
	...
	// Token: 0x06000710 RID: 1808 RVA: 0x000FE0BC File Offset: 0x000FC2BC
	private void Morte()
	{
	...
	// Token: 0x06000711 RID: 1809 RVA: 0x000FE13C File Offset: 0x000FC33C
	private void Attacco()
	{
		...
		if (Physics.Raycast(this.centroBaseInsetto, base.transform.forward, out this.hitAttacco, this.distanzaDiAttacco, this.layerAttacco))
		{
			...
			else if (this.timerDiAttacco > 1.5f && !this.attaccoEffettuato)
			{
			...
			if (this.timerDiAttacco < 2.5f)
			{
				this.insettoAnim.SetBool(this.attaccoHash, true);
			}
			else if (this.timerDiAttacco > 2.5f)
			{
				this.insettoAnim.SetBool(this.attaccoHash, false);
			}
		}
