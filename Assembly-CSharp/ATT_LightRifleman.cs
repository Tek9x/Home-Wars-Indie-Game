...
public class ATT_LightRifleman : MonoBehaviour
{
	// Token: 0x06000213 RID: 531 RVA: 0x00059E6C File Offset: 0x0005806C
	private void Start()
	{
	...
	// Token: 0x06000214 RID: 532 RVA: 0x0005A040 File Offset: 0x00058240
	private void Update()
	{
	...
	// Token: 0x06000215 RID: 533 RVA: 0x0005A32C File Offset: 0x0005852C
	private void InJump()
	{
	...
	// Token: 0x06000216 RID: 534 RVA: 0x0005A3B0 File Offset: 0x000585B0
	...
	// Token: 0x06000217 RID: 535 RVA: 0x0005A610 File Offset: 0x00058810
	...
	// Token: 0x06000218 RID: 536 RVA: 0x0005A728 File Offset: 0x00058928
	...
	// Token: 0x06000219 RID: 537 RVA: 0x0005A7C8 File Offset: 0x000589C8
	...
	// Token: 0x0600021A RID: 538 RVA: 0x0005A848 File Offset: 0x00058A48
	...
	// Token: 0x0600021B RID: 539 RVA: 0x0005B2B0 File Offset: 0x000594B0
	private void AttaccoIndipendente()
	{
		if (base.GetComponent<PresenzaAlleato>().arma1Attivata && this.unitàBersaglio && this.unitàBersaglio.GetComponent<PresenzaNemico>().vita > 0f && !Physics.Linecast(this.bocca1.transform.position, this.centroUnitàBersaglio, this.layerVisuale) && base.GetComponent<PresenzaAlleato>().ListaValoriArma1[5] > 0f && this.timerFrequenzaArma1 > base.GetComponent<PresenzaAlleato>().ListaValoriArma1[0])
		{
			...
			List<float> expr_187 = listaValoriArma = base.GetComponent<PresenzaAlleato>().ListaValoriArma1;
			int index;
			int expr_18A = index = 5;
			float num = listaValoriArma[index];
			expr_187[expr_18A] = num - 1f;
			List<float> listaValoriArma2;
			List<float> expr_1AD = listaValoriArma2 = base.GetComponent<PresenzaAlleato>().ListaValoriArma1;
			int expr_1B1 = index = 6;
			num = listaValoriArma2[index];
			expr_1AD[expr_1B1] = num - 1f;
			...
			List<float> expr_34E = listaDanniAlleati = this.infoNeutreTattica.GetComponent<GestoreNeutroTattica>().ListaDanniAlleati;
			int expr_35C = index = base.GetComponent<PresenzaAlleato>().tipoTruppa;
			num = listaDanniAlleati[index];
			expr_34E[expr_35C] = num + num2;
		}
	}

	// Token: 0x0600021C RID: 540 RVA: 0x0005B630 File Offset: 0x00059830
	...
	// Token: 0x0600021D RID: 541 RVA: 0x0005B98C File Offset: 0x00059B8C
	private void Sparo()
	{
		Ray ray = this.terzaCamera.GetComponent<Camera>().ViewportPointToRay(new Vector3(0.5f, 0.5f, 0f));
